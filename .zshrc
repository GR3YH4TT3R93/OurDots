...
ZSH_TMUX_DEFAULT_SESSION_NAME="EOS"

# Sway-screenshot settings
SWAY_SCREENSHOT_DIR="$HOME/Pictures/Screenshots"
...
if [[ -t 1 ]] && [[ -v WAYLAND_DISPLAY ]] && [[ ! -v TMUX ]] && [[ ! -v ZELLIJ ]]; then
  tmux new -A -s EOS
fi
...
# Fix for CopilotChat.nvim on Termux
...
PATH="/home/gr3y/perl5/bin${PATH:+:${PATH}}"; export PATH;
PERL5LIB="/home/gr3y/perl5/lib/perl5${PERL5LIB:+:${PERL5LIB}}"; export PERL5LIB;
PERL_LOCAL_LIB_ROOT="/home/gr3y/perl5${PERL_LOCAL_LIB_ROOT:+:${PERL_LOCAL_LIB_ROOT}}"; export PERL_LOCAL_LIB_ROOT;
PERL_MB_OPT="--install_base \"/home/gr3y/perl5\""; export PERL_MB_OPT;
PERL_MM_OPT="INSTALL_BASE=/home/gr3y/perl5"; export PERL_MM_OPT;
